...
public class SignUpThree extends JFrame implements ActionListener {
    ...
    SignUpThree(String formno)
    {
     ...
     type.setBounds(90,70,200,30);
     add(type);
     
     r1=new JRadioButton("Saving Account");
     r1.setFont(new Font("Raleway",Font.BOLD,16));
     r1.setBackground(Color.WHITE);
     r1.setBounds(100,120,200,30);
     add(r1);
     
     r2=new JRadioButton("Fixed Deposit Account");
     r2.setFont(new Font("Raleway",Font.BOLD,16));
     r2.setBackground(Color.WHITE);
     r2.setBounds(350,120,200,30);
     add(r2);
     ...
     JLabel number = new JLabel("XXXX-XXXX-XXXX-2333");
    ...
    JLabel services = new JLabel("Services Required :");
     ...
     c7=new JCheckBox("I Hereby declares that the above enterd details are correct tp the best of mu knowledge");
